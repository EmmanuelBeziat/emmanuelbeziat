...
Vous pouvez par exemple utiliser les scripts de [960.gs](http://960.gs/) (ou les modèles fournis), ou bien des [templates prédéfinis](http://www.ravelrumba.com/photoshop-grids/ "Photoshop Grids"). Plus d’explications dans cet article de Smashing Magazine : [<q>Establishing your grid in photoshop (en)</q>](http://www.smashingmagazine.com/2011/11/09/establishing-your-grid-in-photoshop/).
...
<div class="note note--important">La maquette est une étape importante et ne doit pas être expédiée ni négligée. Les maquettes présentées au client devraient toujours d’abord être validées par des développeurs et des ergonomes.</div>
